    ...
    <div class="">
        <div class="pageHeader">
            <div class="pageBread">
                ...
                <BreadcrumbItem>APP引导页</BreadcrumbItem>
                </Breadcrumb>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            list () {
                ...
                this.$api.post("/appGuidePage/page", data, reset => {
                    if (reset.code === 0) {
            ...
            itemdel (params) {
                ...
                this.$api.post("/appGuidePage/delete", data, reset => {
                    if (reset.code === 0) {
            ...
            add () {
                this.$router.push({path:"/apk/guide/add"})
            }
        }
    }
</script>
