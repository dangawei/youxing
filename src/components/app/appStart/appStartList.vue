    ...
    <div class="">
        <div class="pageHeader">
            <div class="pageBread">
                ...
                <BreadcrumbItem>APP启动页</BreadcrumbItem>
                </Breadcrumb>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            list () {
                ...
                this.$api.post("/appStartPage/page", data, reset => {
                    if (reset.code === 0) {
            ...
            itemdel (params) {
                ...
                this.$api.post("/appStartPage/delete", data, reset => {
                    if (reset.code === 0) {
            ...
            add () {
                this.$router.push({path:"/apk/start/add"})
            }
        }
    }
</script>
