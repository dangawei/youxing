<template>
    <div id="account">
        <div class="pageHeader">
            <div class="pageBread">
                <Breadcrumb>
                    ...
                    <BreadcrumbItem>分公司账号列表</BreadcrumbItem>
                </Breadcrumb>
            </div>
        ...
        <add-branch-account :addshow="addShow" @addShowComponent="importShow" v-if="addShow"></add-branch-account>
...
<script>
    import addBranchAccount from './addBranchAccount.vue'
