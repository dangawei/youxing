            ...
            <div style="text-align:center">
                <Form ref="adddatas" :model="adddatas" :rules="ruleValidate" :label-width="100">
                    <FormItem label="车辆编号" prop="vehicleNo">
                        <!-- <bike-auto-complete @exportData="exportNo"></bike-auto-complete> -->
                        <Input v-model="adddatas.vehicleNo" placeholder="车辆编号" onkeydown="if(event.keyCode==32) return false"></Input>
                    </FormItem>
